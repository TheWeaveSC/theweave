...
The write verbs also acquire an advisory cross-machine lease around each write (`weave/lease.py`) — see [`docs/lease.md`](lease.md) for exactly what it does and does not guarantee on iCloud.
