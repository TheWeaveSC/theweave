...
./weave-cli demo boot "ACME cutover with Eddie"
...
- **The seed vault uses fictional entity names** (ACME / FOO / Eddie) so nothing looks like a stale copy of real Weave data if anyone glances at this directory.
